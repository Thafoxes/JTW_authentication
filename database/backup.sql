...
-- Dumping data for table jwt_dbms.user: ~2 rows (approximately)
REPLACE INTO `user` (`user_id`, `username`, `email`, `member_valid`, `date_joined`, `role`, `password_hash`) VALUES
	(1, 'developer', 'developer@example.com', 1, '2026-05-25 00:00:00', 'admin', '$2y$10$I6bS5SgcBWeLdMGc1HRBjeCyS7Y6EoJy7E3fpMnw7g6ye81DR0l6m'),
	(2, 'user', 'user@example.com', 1, '2026-05-26 00:00:00', 'member', '$2y$10$52.OjL/Ewa1.Xac5zDP.4eaa0/WA6z0nBpppuh77IlIhHDw0BuyLO');
